        ...
        <section className="flex flex-col items-center gap-6 animate-fade-in">
          <div className="flex flex-col items-center text-center">
            <div className="flex flex-row items-center justify-center gap-4 md:gap-6 mb-2">
              <svg className="w-[76px] h-[76px] md:w-[110px] md:h-[110px] drop-shadow-md animate-floating flex-shrink-0 pb-2" viewBox="0 0 24 24" fill="none" stroke="url(#gradLogoHero)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <defs>
              ...
              <h1 className="text-[36px] md:text-[56px] lg:text-[64px] font-extrabold tracking-tight bg-gradient-to-r from-[#8a2387] to-[#e94057] bg-clip-text text-transparent pb-2 leading-none text-left">
                Calcola il tuo<br />voto di laurea
              </h1>
            </div>
