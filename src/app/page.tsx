        ...
        <section className="flex flex-col items-center gap-6 animate-fade-in">
          <div className="flex flex-col items-center text-center">
            <div className="flex flex-row items-center justify-center gap-4 md:gap-6 mb-2">
              <svg className="w-[44px] h-[44px] md:w-[64px] md:h-[64px] drop-shadow-md -rotate-12 flex-shrink-0 pb-2" viewBox="0 0 24 24" fill="none" stroke="url(#gradLogoHero)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <defs>
