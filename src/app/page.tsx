        ...
        <section className="flex flex-col items-center gap-6 animate-fade-in">
          <div className="flex flex-col items-center text-center">
            <div className="flex items-center justify-center gap-[4px] md:gap-[8px] mb-2">
              <svg className="w-[54px] h-[54px] md:w-[72px] md:h-[72px] drop-shadow-md" viewBox="0 0 24 24" fill="none" stroke="url(#gradLogoHero)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <defs>
              ...
              <h1 className="text-[64px] md:text-[96px] font-extrabold tracking-tight bg-gradient-to-r from-[#8a2387] to-[#e94057] bg-clip-text text-transparent pb-[4px] md:pb-[6px] leading-none">
                Gradly
              </h1>
            </div>
